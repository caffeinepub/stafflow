...
var ve = (n) => {
  ...
  let { invert: e, toast: t2, unstyled: a, interacting: u, setHeights: f, visibleToasts: w, heights: S, index: g, toasts: i, expanded: D, removeToast: T, defaultRichColors: F, closeButton: et, style: ut, cancelButtonStyle: ft, actionButtonStyle: l, className: ot = "", descriptionClassName: at = "", duration: X2, position: st, gap: pt, loadingIcon: rt, expandByDefault: B, classNames: s, icons: P, closeButtonAriaLabel: nt = "Close toast", pauseWhenPageIsHidden: it } = n, [Y, C] = o.useState(null), [lt, J] = o.useState(null), [W, H] = o.useState(false), [A, mt] = o.useState(false), [L, z] = o.useState(false), [ct, d] = o.useState(false), [h, y] = o.useState(false), [R, j] = o.useState(0), [p, _] = o.useState(0), O = o.useRef(t2.duration || X2 || Wt), G = o.useRef(null), k = o.useRef(null), Vt = g === 0, Ut = g + 1 <= w, N = t2.type, V = t2.dismissible !== false, Kt = t2.className || "", Xt = t2.descriptionClassName || "", dt = o.useMemo(() => S.findIndex((r) => r.toastId === t2.id) || 0, [S, t2.id]), Jt = o.useMemo(() => {
    var r;
    return (r = t2.closeButton) != null ? r : et;
  }, [t2.closeButton, et]), Tt = o.useMemo(() => t2.duration || X2 || Wt, [t2.duration, X2]), gt = o.useRef(0), U = o.useRef(0), St = o.useRef(0), K = o.useRef(null), [Gt, Qt] = st.split("-"), Rt = o.useMemo(() => S.reduce((r, m, c) => c >= dt ? r : r + m.height, 0), [S, dt]), Et = Ft(), qt = t2.invert || e, ht = N === "loading";
  ...
  }, [D, u, t2, N, it, Et, $]), o.useEffect(() => {
    t2.delete && $();
  }, [$, t2.delete]);
  function Zt() {
    var r, m, c;
    return P != null && P.loading ? o.createElement("div", { className: M(s == null ? void 0 : s.loader, (r = t2 == null ? void 0 : t2.classNames) == null ? void 0 : r.loader, "sonner-loader"), "data-visible": N === "loading" }, P.loading) : rt ? o.createElement("div", { className: M(s == null ? void 0 : s.loader, (m = t2 == null ? void 0 : t2.classNames) == null ? void 0 : m.loader, "sonner-loader"), "data-visible": N === "loading" }, rt) : o.createElement(Yt, { className: M(s == null ? void 0 : s.loader, (c = t2 == null ? void 0 : t2.classNames) == null ? void 0 : c.loader), visible: N === "loading" });
  }
  return o.createElement("li", { tabIndex: 0, ref: k, className: M(ot, Kt, s == null ? void 0 : s.toast, (Dt = t2 == null ? void 0 : t2.classNames) == null ? void 0 : Dt.toast, s == null ? void 0 : s.default, s == null ? void 0 : s[N], (Pt = t2 == null ? void 0 : t2.classNames) == null ? void 0 : Pt[N]), "data-sonner-toast": "", "data-rich-colors": (Nt = t2.richColors) != null ? Nt : F, "data-styled": !(t2.jsx || t2.unstyled || a), "data-mounted": W, "data-promise": !!t2.promise, "data-swiped": h, "data-removed": A, "data-visible": Ut, "data-y-position": Gt, "data-x-position": Qt, "data-index": g, "data-front": Vt, "data-swiping": L, "data-dismissible": V, "data-type": N, "data-invert": qt, "data-swipe-out": ct, "data-swipe-direction": lt, "data-expanded": !!(D || B && W), style: { "--index": g, "--toasts-before": g, "--z-index": i.length - g, "--offset": `${A ? R : U.current}px`, "--initial-height": B ? "auto" : `${p}px`, ...ut, ...t2.style }, onDragEnd: () => {
    ...
    if (Math.abs(b) >= ye || I > 0.11) {
      j(U.current), (Z = t2.onDismiss) == null || Z.call(t2, t2), J(Y === "x" ? r > 0 ? "right" : "left" : m > 0 ? "down" : "up"), $(), d(true), y(false);
      return;
    }
    z(false), C(null);
  }, onPointerMove: (r) => {
...
const t = {
  tr: {
    ...
    lateCheckoutAlert: "10+ saatten beri içeride - çıkış yapmayı unutmuş olabilir"
  },
  en: {
    appName: "StafFlow",
    ...
    lateCheckoutAlert: "Checked in 10+ hours ago - may have forgotten to check out"
  },
  de: {
    appName: "StafFlow",
    ...
    saveCodeWarning: "Speichern Sie diesen Code! Er wird nicht erneut angezeigt.",
    ...
    lateCheckoutAlert: "Seit 10+ Stunden eingecheckt - hat möglicherweise das Ausstempeln vergessen"
  },
  fr: {
    appName: "StafFlow",
    ...
    lateCheckoutAlert: "Pointé il y a 10h+ - a peut-être oublié de pointer le départ"
  },
  es: {
    appName: "StafFlow",
    ...
    lateCheckoutAlert: "Registrado hace 10h+ - puede haber olvidado registrar salida"
  },
  pt: {
    appName: "StafFlow",
    ...
    lateCheckoutAlert: "Registrado há 10h+ - pode ter esquecido de registrar saída"
  },
  ar: {
    appName: "StafFlow",
  ...
  ru: {
    ...
    lateCheckoutAlert: "Отметил приход 10+ часов назад - возможно забыл отметить уход"
  },
  zh: {
    appName: "StafFlow",
    appTagline: "员工追踪系统",
  ...
  ja: {
    ...
    workedToday: "本日の勤務時間",
    lateCheckoutAlert: "チェックインから10時間以上 - チェックアウトを忘れた可能性があります"
  }
};
function useTranslations(lang) {
  return (key) => {
    var _a2;
    return ((_a2 = t[lang]) == null ? void 0 : _a2[key]) ?? t.en[key] ?? key;
  };
}
/**
...
function uniqueCode(length, existing) {
...
function getRecordDuration(record, allRecords) {
  if (record.recordType !== "checkout") return "-";
  const paired = allRecords.filter(
    (r) => r.employeeId === record.employeeId && r.companyId === record.companyId && r.recordType === "checkin" && r.timestamp < record.timestamp
  ).sort((a, b) => b.timestamp - a.timestamp)[0];
  if (!paired) return "-";
  return formatDuration(paired.timestamp, record.timestamp);
}
function getCheckedInEmployees(companyId) {
  const employees = load(KEYS.employees).filter(
    (e) => e.companyIds.includes(companyId)
  );
  const result = [];
...
function registerCompany(name, authorizedPerson) {
  if (!name.trim())
    return {
      ok: false,
      companyId: "",
  ...
  const company = {
    id,
    name: name.trim(),
    authorizedPerson: (authorizedPerson == null ? void 0 : authorizedPerson.trim()) || void 0,
    loginCode,
    createdAt: Date.now()
  };
...
function loginCompany(loginCode) {
  const companies = load(KEYS.companies);
...
function createInviteCode(companyId, maxUses, expiresAt) {
  const inviteCodes = load(KEYS.inviteCodes);
...
function cancelInviteCode(inviteId, companyId) {
  const inviteCodes = load(KEYS.inviteCodes);
...
function getCompanyInviteCodes(companyId) {
  return load(KEYS.inviteCodes).filter(
    (c) => c.companyId === companyId
  );
}
function getCompanyEmployees(companyId) {
  return load(KEYS.employees).filter(
    (e) => e.companyIds.includes(companyId)
  );
}
function getCompanyAttendance(companyId, fromTime, toTime, employeeId) {
  return load(KEYS.attendance).filter((r) => {
...
function getAllCompanyAttendance(companyId) {
  return load(KEYS.attendance).filter((r) => r.companyId === companyId).sort((a, b) => a.timestamp - b.timestamp);
}
function getDailyCheckinCount(companyId, dayStart, dayEnd) {
  return load(KEYS.attendance).filter(
    (r) => r.companyId === companyId && r.recordType === "checkin" && r.timestamp >= dayStart && r.timestamp <= dayEnd
  ).length;
}
function registerEmployee(fullName, phone) {
  if (!fullName.trim())
    return {
      ok: false,
      employeeId: "",
  ...
  const employee = {
    ...
    phone: (phone == null ? void 0 : phone.trim()) || void 0,
    loginCode,
    companyIds: [],
    createdAt: Date.now()
  };
...
function loginEmployee(loginCode) {
  const employees = load(KEYS.employees);
...
function getEmployee(id) {
  return load(KEYS.employees).find((e) => e.id === id);
}
function getCompany(id) {
  return load(KEYS.companies).find((c) => c.id === id);
}
function joinCompany(employeeId, inviteCode) {
  const inviteCodes = load(KEYS.inviteCodes);
  ...
  if (invite.maxUses !== void 0 && invite.usedCount >= invite.maxUses)
    return {
      ok: false,
      companyName: "",
  ...
  return {
    ok: true,
    companyName: (company == null ? void 0 : company.name) || "",
    message: "Successfully joined company"
  };
}
function toggleAttendance(employeeId, companyId) {
  ...
  const records = load(KEYS.attendance).filter((r) => r.employeeId === employeeId && r.companyId === companyId).sort((a, b) => b.timestamp - a.timestamp);
  const lastRecord = records[0];
  const isCurrentlyIn = lastRecord && lastRecord.recordType === "checkin";
  const newType = isCurrentlyIn ? "checkout" : "checkin";
  const now2 = Date.now();
  const id = nextId();
  const record = {
    id,
...
function getLastAttendanceStatus(employeeId, companyId) {
  const records = load(KEYS.attendance).filter((r) => r.employeeId === employeeId && r.companyId === companyId).sort((a, b) => b.timestamp - a.timestamp);
...
function getEmployeeAttendance(employeeId, companyId, fromTime, toTime) {
  return load(KEYS.attendance).filter((r) => {
...
function getInviteCodeStatus(invite) {
...
function CompanyAuth({
  ...
  const [authorizedPerson, setAuthorizedPerson] = reactExports.useState("");
  const [loading, setLoading] = reactExports.useState(false);
  const [newCode, setNewCode] = reactExports.useState(null);
  const [copied, setCopied] = reactExports.useState(false);
  function handleLogin() {
    if (!loginCode.trim()) {
      ue.error(t2("codeRequired"));
      return;
    }
    setLoading(true);
    ...
    if (!res.ok || !res.company) {
      ue.error(t2("invalidCode"));
      return;
    }
    ue.success(t2("success"));
    onLogin({ type: "company", id: res.company.id, name: res.company.name });
  }
  function handleRegister() {
    if (!companyName.trim()) {
      ue.error(t2("companyRequired"));
      return;
    }
    setLoading(true);
    const res = registerCompany(companyName, authorizedPerson || void 0);
    setLoading(false);
    if (!res.ok) {
      ue.error(res.message);
      return;
    }
    setNewCode({ code: res.loginCode, companyName });
  }
  function copyCode() {
    navigator.clipboard.writeText((newCode == null ? void 0 : newCode.code) || "");
    setCopied(true);
  ...
  if (newCode) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center p-6 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-8 shadow-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-green-500/20 flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 32, className: "text-green-500" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold", children: newCode.companyName }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: t2("success") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted rounded-xl p-4 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mb-2", children: t2("yourLoginCode") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "text-lg font-mono font-bold tracking-widest flex-1 text-blue-400", children: newCode.code }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 16, className: "text-green-500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { size: 16 })
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-amber-500/10 border border-amber-500/30 rounded-lg p-3 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-amber-400 text-sm text-center", children: [
        "⚠️ ",
        t2("saveCodeWarning")
      ] }) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between px-6 py-4 border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: t2("back") })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            ...
            children: LANGUAGES.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: l.code, children: l.label }, l.code))
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex items-center justify-center p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold", children: t2("companyLogin") }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl overflow-hidden shadow-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex border-b border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: `flex-1 py-4 text-sm font-medium transition-colors ${tab === "login" ? "bg-blue-600/10 text-blue-400 border-b-2 border-blue-500" : "text-muted-foreground hover:text-foreground"}`,
              children: t2("login")
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: `flex-1 py-4 text-sm font-medium transition-colors ${tab === "register" ? "bg-blue-600/10 text-blue-400 border-b-2 border-blue-500" : "text-muted-foreground hover:text-foreground"}`,
              children: t2("register")
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6", children: tab === "login" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-sm font-medium mb-2", children: t2("loginCode") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: loading ? t2("loading") : t2("login")
            }
          )
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-sm font-medium mb-2", children: t2("companyName") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                id: "company-name",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-sm font-medium mb-2", children: t2("authorizedPerson") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              disabled: loading,
              className: "w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white font-semibold py-3 rounded-xl transition-colors",
              children: loading ? t2("loading") : t2("createCompany")
            }
          )
        ] }) })
      ] })
...
function CompanyDashboard({
  ...
  const [inviteCodes, setInviteCodes] = reactExports.useState([]);
  const [employees, setEmployees] = reactExports.useState([]);
  const [attendance, setAttendance] = reactExports.useState([]);
  const [allAttendance, setAllAttendance] = reactExports.useState([]);
  const [todayCount, setTodayCount] = reactExports.useState(0);
  const [checkedInList, setCheckedInList] = reactExports.useState([]);
  const [showCreateInvite, setShowCreateInvite] = reactExports.useState(false);
  const [maxUses, setMaxUses] = reactExports.useState("");
  const [expiryDate, setExpiryDate] = reactExports.useState("");
  const [creatingInvite, setCreatingInvite] = reactExports.useState(false);
  const [newInviteCode, setNewInviteCode] = reactExports.useState("");
  const [copiedInvite, setCopiedInvite] = reactExports.useState(false);
  const [filterEmpId, setFilterEmpId] = reactExports.useState("");
  ...
  const loadAttendance = reactExports.useCallback(() => {
    const from = filterFrom ? new Date(filterFrom).getTime() : void 0;
    const to = filterTo ? (/* @__PURE__ */ new Date(`${filterTo}T23:59:59`)).getTime() : void 0;
    setAttendance(
      getCompanyAttendance(session.id, from, to, filterEmpId || void 0)
    );
  ...
  function handleCreateInvite() {
    ...
    const mu = maxUses ? Number.parseInt(maxUses) : void 0;
    const exp = expiryDate ? (/* @__PURE__ */ new Date(`${expiryDate}T23:59:59`)).getTime() : void 0;
  ...
  function handleCancelInvite(id) {
    ...
    if (res.ok) {
      ue.success(t2("success"));
      loadData();
    } else ue.error(res.message);
  }
  function copyInvite() {
    navigator.clipboard.writeText(newInviteCode);
    setCopiedInvite(true);
    setTimeout(() => setCopiedInvite(false), 2e3);
  }
  ...
  function handleExportCSV() {
    const headers = [t2("employee"), t2("type"), t2("date"), t2("duration")];
    const rows = attendance.map((rec) => [
      `"${rec.employeeName}"`,
      rec.recordType === "checkin" ? t2("checkinType") : t2("checkoutType"),
      `"${formatDate$1(rec.timestamp)}"`,
  ...
  const lateEmployees = checkedInList.filter(
    ({ checkinTimestamp }) => Date.now() - checkinTimestamp > LATE_THRESHOLD_HOURS * 60 * 60 * 1e3
  );
  const tabs = [
    { key: "overview", label: t2("overview"), icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { size: 16 }) },
    { key: "live", label: t2("liveStatus"), icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 16 }) },
    { key: "invites", label: t2("inviteCodes"), icon: /* @__PURE__ */ jsxRuntimeExports.jsx(QrCode, { size: 16 }) },
    { key: "employees", label: t2("employees"), icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 16 }) },
    {
      key: "attendance",
      label: t2("attendance"),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between px-4 md:px-6 py-4 border-b border-border bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 16, className: "text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-sm", children: session.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: t2("companyLogin") })
        ] })
      ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:inline", children: t2("logout") })
            ]
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex border-b border-border bg-card overflow-x-auto", children: tabs.map((tb) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        onClick: () => setTab(tb.key),
        className: `flex items-center gap-2 px-4 py-3 text-sm font-medium whitespace-nowrap transition-colors ${tab === tb.key ? "text-blue-400 border-b-2 border-blue-500 bg-blue-600/5" : "text-muted-foreground hover:text-foreground"}`,
        children: [
          tb.icon,
          tb.label,
          tb.key === "live" && checkedInList.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 bg-green-500 text-white text-xs rounded-full w-4 h-4 flex items-center justify-center", children: checkedInList.length })
        ]
      },
      tb.key
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 p-4 md:p-6 max-w-5xl mx-auto w-full", children: [
      tab === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold mb-6", children: t2("overview") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              label: t2("todayCheckins"),
              value: todayCount,
              color: "blue"
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              label: t2("currentlyIn"),
              value: checkedInList.length,
              color: "orange"
            }
          )
        ] }),
        (company == null ? void 0 : company.authorizedPerson) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 bg-card border border-border rounded-xl p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: t2("authorizedPerson") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium mt-1", children: company.authorizedPerson })
        ] }),
        lateEmployees.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 bg-red-500/10 border border-red-500/30 rounded-xl p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { size: 16, className: "text-red-400" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-red-400", children: t2("lateWarning") })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: lateEmployees.map(({ employee, checkinTimestamp }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex items-center justify-between text-sm",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: employee.fullName }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-red-400 text-xs", children: [
      ...
      tab === "live" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold mb-6", children: t2("liveStatus") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2.5 h-2.5 rounded-full bg-green-400 animate-pulse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-semibold text-green-400", children: [
                t2("currentlyIn"),
                " (",
            ...
            checkedInList.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl p-8 text-center text-muted-foreground text-sm", children: t2("noOneSite") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: checkedInList.map(({ employee, checkinTimestamp }) => {
              const isLate = Date.now() - checkinTimestamp > LATE_THRESHOLD_HOURS * 60 * 60 * 1e3;
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `bg-card border rounded-xl p-4 flex items-center justify-between ${isLate ? "border-red-500/40 bg-red-500/5" : "border-border"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-sm", children: employee.fullName }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-0.5", children: formatDate$1(checkinTimestamp) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: `text-xs font-mono px-2 py-1 rounded-lg ${isLate ? "bg-red-500/20 text-red-400" : "bg-green-500/20 text-green-400"}`,
                          children: formatDuration(checkinTimestamp, Date.now())
                        }
                      ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2.5 h-2.5 rounded-full bg-gray-400" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-semibold text-muted-foreground", children: [
                t2("currentlyOut"),
                " (",
            ...
            employees.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl p-8 text-center text-muted-foreground text-sm", children: t2("noEmployees") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: employees.filter(
              (emp) => !checkedInList.some(
                ({ employee }) => employee.id === emp.id
              )
            ).map((emp) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "bg-card border border-border rounded-xl p-4 flex items-center justify-between",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-sm", children: emp.fullName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-gray-500/20 text-gray-400 px-2 py-1 rounded-lg", children: t2("checkedOut") })
                ]
              },
              emp.id
            )) })
      ...
      tab === "invites" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold", children: t2("inviteCodes") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
        ...
        inviteCodes.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { text: t2("noInviteCodes") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: inviteCodes.map((inv) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "font-mono font-bold text-blue-400 tracking-widest", children: inv.code }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-wrap gap-2 text-xs text-muted-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status, t: t2 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                    t2("uses"),
                    ": ",
                    inv.usedCount,
                    "/",
                    inv.maxUses ?? t2("unlimited")
                  ] }),
                  inv.expiresAt && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                    t2("expiryDate"),
                    ": ",
                    formatDateOnly(inv.expiresAt)
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatDate$1(inv.createdAt) })
                ] }),
      ...
      tab === "employees" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold mb-6", children: t2("employees") }),
        employees.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { text: t2("noEmployees") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: t2("fullName") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: t2("phone") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: t2("status") })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: employees.map((emp) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium", children: emp.fullName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: emp.phone || "-" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                      className: `inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-xs font-medium ${isIn ? "bg-green-500/20 text-green-400" : "bg-gray-500/20 text-gray-400"}`,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                        ...
                        isIn ? t2("checkedIn") : t2("checkedOut")
                      ]
                    }
                  ) })
                ]
      ...
      tab === "attendance" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold", children: t2("attendance") }),
          attendance.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 mb-4 grid grid-cols-1 sm:grid-cols-3 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mb-1", children: t2("from") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "date",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mb-1", children: t2("to") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "date",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mb-1", children: t2("employee") }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                value: filterEmpId,
                ...
                className: "w-full bg-background border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: t2("allEmployees") }),
                  employees.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: e.id, children: e.fullName }, e.id))
                ]
              }
            )
          ] })
        ] }),
        attendance.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { text: t2("noRecords") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: t2("employee") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: t2("type") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: t2("date") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: t2("duration") })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: attendance.map((rec) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                className: "border-b border-border last:border-0 hover:bg-muted/50 transition-colors",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium", children: rec.employeeName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                      className: `inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-xs font-medium ${rec.recordType === "checkin" ? "bg-green-500/20 text-green-400" : "bg-gray-500/20 text-gray-400"}`,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: formatDate$1(rec.timestamp) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground font-mono text-xs", children: dur !== "-" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-blue-500/10 text-blue-400 px-2 py-0.5 rounded", children: dur }) : "-" })
                ]
              },
              rec.id
            );
    ...
    showCreateInvite && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "dialog",
      {
        open: true,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0", onClick: closeInviteModal }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-6 w-full max-w-md shadow-2xl relative z-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold", children: t2("createInviteCode") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
            ...
            newInviteCode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted rounded-xl p-4 mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mb-2", children: t2("inviteCode") }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "text-xl font-mono font-bold tracking-widest flex-1 text-blue-400", children: newInviteCode }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      onClick: copyInvite,
                      className: "p-2 hover:bg-background rounded-lg transition-colors",
                      children: copiedInvite ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 16, className: "text-green-500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { size: 16 })
                    }
                  )
                ] })
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium mb-2", children: t2("maxUses") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "number",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium mb-2", children: t2("expiryDate") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "date",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: creatingInvite ? t2("loading") : t2("create")
                  }
                )
              ] })
            ] })
...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `bg-gradient-to-br ${colors[color]} border rounded-xl p-5`, children: [
...
function EmployeeAuth({
  ...
  function handleRegister() {
    if (!fullName.trim()) {
      ue.error(t2("nameRequired"));
      return;
    }
    setLoading(true);
    const res = registerEmployee(fullName, phone || void 0);
    setLoading(false);
    if (!res.ok) {
      ue.error(res.message);
      return;
  ...
  if (newCode) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center p-6 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-8 shadow-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-green-500/20 flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 32, className: "text-green-500" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold", children: newCode.empName }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: t2("success") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted rounded-xl p-4 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mb-2", children: t2("yourLoginCode") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "text-lg font-mono font-bold tracking-widest flex-1 text-green-400", children: newCode.code }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex items-center justify-center p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold", children: t2("employeeLogin") }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl overflow-hidden shadow-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex border-b border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => setTab("login"),
              className: `flex-1 py-4 text-sm font-medium transition-colors ${tab === "login" ? "bg-green-600/10 text-green-400 border-b-2 border-green-500" : "text-muted-foreground hover:text-foreground"}`,
              children: t2("login")
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => setTab("register"),
              className: `flex-1 py-4 text-sm font-medium transition-colors ${tab === "register" ? "bg-green-600/10 text-green-400 border-b-2 border-green-500" : "text-muted-foreground hover:text-foreground"}`,
              children: t2("register")
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6", children: tab === "login" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-sm font-medium mb-2", children: t2("fullName") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                id: "emp-fullname",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-sm font-medium mb-2", children: t2("phone") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                id: "emp-phone",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              disabled: loading,
              className: "w-full bg-green-600 hover:bg-green-700 disabled:opacity-50 text-white font-semibold py-3 rounded-xl transition-colors",
              children: loading ? t2("loading") : t2("createEmployee")
            }
          )
        ] }) })
      ] })
...
const useQRScanner = (config) => {
  ...
  const scanQRCode = reactExports.useCallback(() => {
    ...
    if ((code == null ? void 0 : code.data) && code.data !== lastScanRef.current) {
      ...
      const newResult = { data: code.data, timestamp: Date.now() };
      if (isMountedRef.current) {
...
function EmployeeDashboard({
  ...
  const [tab, setTab] = reactExports.useState("companies");
  const [employee, setEmployee] = reactExports.useState(null);
  const [companies, setCompanies] = reactExports.useState([]);
  const [checkinStatus, setCheckinStatus] = reactExports.useState({});
  const [attendance, setAttendance] = reactExports.useState([]);
  const [allEmpAttendance, setAllEmpAttendance] = reactExports.useState(
    []
  );
  const [toggling, setToggling] = reactExports.useState("");
  const [showJoin, setShowJoin] = reactExports.useState(false);
  const [inviteInput, setInviteInput] = reactExports.useState("");
  const [joining, setJoining] = reactExports.useState(false);
  const [showScanner, setShowScanner] = reactExports.useState(false);
  const [scanForCompany, setScanForCompany] = reactExports.useState("");
  const scanner = useQRScanner({ facingMode: "environment" });
  const [filterCompanyId, setFilterCompanyId] = reactExports.useState("");
  const [filterFrom, setFilterFrom] = reactExports.useState("");
  const [filterTo, setFilterTo] = reactExports.useState("");
  const loadEmployee = reactExports.useCallback(() => {
    const emp = getEmployee(session.id);
    if (!emp) return;
    setEmployee(emp);
    const comps = emp.companyIds.map((id) => getCompany(id)).filter(Boolean);
    setCompanies(comps);
    const statuses = {};
  ...
  const loadAttendance = reactExports.useCallback(() => {
    ...
    const to = filterTo ? (/* @__PURE__ */ new Date(`${filterTo}T23:59:59`)).getTime() : void 0;
    setAttendance(
      getEmployeeAttendance(session.id, filterCompanyId || void 0, from, to)
    );
  ...
  const scannedRef = reactExports.useRef(false);
  reactExports.useEffect(() => {
  ...
  function handleToggle(companyId) {
    ...
    ue.success(res.recordType === "checkin" ? t2("checkIn") : t2("checkOut"));
    loadEmployee();
  ...
  function handleJoinCompany() {
    ...
    ue.success(`${t2("joinedCompany")}: ${res.companyName}`);
    setShowJoin(false);
    setInviteInput("");
    loadEmployee();
  }
  function openScanner(companyId) {
  ...
  const tabs = [
    { key: "companies", label: t2("myCompanies"), icon: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 16 }) },
    {
      key: "history",
      label: t2("attendanceHistory"),
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 16 })
    },
    { key: "qr", label: t2("myQRCode"), icon: /* @__PURE__ */ jsxRuntimeExports.jsx(QrCode, { size: 16 }) }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between px-4 md:px-6 py-4 border-b border-border bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-green-600 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 16, className: "text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-sm", children: session.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: t2("employeeLogin") })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex border-b border-border bg-card overflow-x-auto", children: tabs.map((tb) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        onClick: () => setTab(tb.key),
        className: `flex items-center gap-2 px-4 py-3 text-sm font-medium whitespace-nowrap transition-colors ${tab === tb.key ? "text-green-400 border-b-2 border-green-500 bg-green-600/5" : "text-muted-foreground hover:text-foreground"}`,
        children: [
          tb.icon,
          tb.label
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 p-4 md:p-6 max-w-3xl mx-auto w-full", children: [
      tab === "companies" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold", children: t2("myCompanies") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
        ...
        companies.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-4", children: "🏢" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-4", children: t2("noCompanies") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              children: t2("joinCompany")
            }
          )
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: companies.map((company) => {
          const status = checkinStatus[company.id];
          const isCheckedIn = (status == null ? void 0 : status.isCheckedIn) ?? false;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-lg", children: company.name }),
                    (status == null ? void 0 : status.lastTimestamp) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground mt-1", children: [
                      isCheckedIn ? t2("checkedIn") : t2("checkedOut"),
                      ":",
                      " ",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: `flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium ${isCheckedIn ? "bg-green-500/20 text-green-400" : "bg-gray-500/20 text-gray-400"}`,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            className: `w-2 h-2 rounded-full ${isCheckedIn ? "bg-green-400 animate-pulse" : "bg-gray-400"}`
                          }
                        ),
                        isCheckedIn ? t2("checkedIn") : t2("checkedOut")
                      ]
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      className: `flex-1 py-4 rounded-xl font-bold text-lg transition-all ${isCheckedIn ? "bg-red-500/20 hover:bg-red-500/30 text-red-400 border border-red-500/30" : "bg-green-500/20 hover:bg-green-500/30 text-green-400 border border-green-500/30"} disabled:opacity-50`,
                      children: toggling === company.id ? t2("loading") : isCheckedIn ? t2("checkOut") : t2("checkIn")
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
      ...
      tab === "history" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold mb-6", children: t2("attendanceHistory") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 mb-4 grid grid-cols-1 sm:grid-cols-3 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-xs text-muted-foreground mb-1", children: t2("from") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "date",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-xs text-muted-foreground mb-1", children: t2("to") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "date",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-xs text-muted-foreground mb-1", children: t2("selectCompany") }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
        ...
        attendance.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16 text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: "📋" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: t2("noRecords") })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: t2("type") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: t2("selectCompany") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: t2("date") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: t2("duration") })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: attendance.map((rec) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: ((_a2 = getCompany(rec.companyId)) == null ? void 0 : _a2.name) || "-" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: formatDate(rec.timestamp) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-mono text-xs text-muted-foreground", children: dur !== "-" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-green-500/10 text-green-400 px-2 py-0.5 rounded", children: dur }) : "-" })
                ]
              },
              rec.id
            );
      ...
      tab === "qr" && employee && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold mb-6", children: t2("myQRCode") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-6 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(QRCodeDisplay, { value: employee.loginCode }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "font-mono text-lg font-bold tracking-widest text-green-400", children: employee.loginCode }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-2", children: t2("qrDesc") })
          ] })
        ] })
      ] })
    ] }),
    showJoin && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "dialog",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-6 w-full max-w-md shadow-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold", children: t2("joinCompany") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-sm font-medium mb-2", children: t2("inviteCode") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "text",
                  ...
                  placeholder: t2("enterInviteCode"),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: joining ? t2("loading") : t2("join")
                }
              )
            ] })
          ] })
    ...
    showScanner && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 bg-black/90 flex flex-col items-center justify-center z-50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white text-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold", children: t2("scanQR") }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 border-2 border-green-400 rounded-xl pointer-events-none" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
function QRCodeDisplay({ value }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white p-3 rounded-xl inline-block shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { ref: canvasRef, style: { display: "block" } }) }) });
}
function LandingPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-gradient-to-br from-background via-background to-muted", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between px-6 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-sm", children: "SF" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-lg tracking-tight", children: "StafFlow" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onClick: () => setDark(!dark),
            className: "p-2 rounded-lg hover:bg-muted transition-colors",
            title: dark ? t2("lightMode") : t2("darkMode"),
            children: dark ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { size: 18 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { size: 18 })
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col items-center justify-center px-6 py-12 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-2xl bg-blue-600 flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-blue-600/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-3xl", children: "SF" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-5xl font-bold mb-3 bg-gradient-to-r from-blue-500 to-blue-300 bg-clip-text text-transparent", children: "StafFlow" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg", children: t2("appTagline") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-xl bg-blue-600/10 flex items-center justify-center group-hover:bg-blue-600/20 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 32, className: "text-blue-500" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-lg", children: t2("companyLogin") }) })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-xl bg-green-600/10 flex items-center justify-center group-hover:bg-green-600/20 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 32, className: "text-green-500" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-lg", children: t2("employeeLogin") }) })
            ]
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "text-center py-4 text-muted-foreground text-sm", children: [
      "StafFlow © ",
...
function App() {
  ...
  const [lang, setLang] = reactExports.useState(
    () => localStorage.getItem("sf_lang") || "tr"
  );
  ...
  const commonProps = { lang, setLang, dark, setDark, t: t2 };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: dark ? "dark" : "", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx($e, { position: "top-right", richColors: true }),
    page === "landing" && /* @__PURE__ */ jsxRuntimeExports.jsx(LandingPage, { ...commonProps, setPage }),
    page === "company-auth" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      CompanyAuth,
      {
        ...commonProps,
        setPage,
    ...
    page === "company-dashboard" && session && /* @__PURE__ */ jsxRuntimeExports.jsx(
      CompanyDashboard,
      {
        ...commonProps,
        session,
    ...
    page === "employee-auth" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmployeeAuth,
      {
        ...commonProps,
        setPage,
    ...
    page === "employee-dashboard" && session && /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmployeeDashboard,
      {
        ...commonProps,
        session,
